...
namespace GraysPavers.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "The  First Name Field Must be at least One character.", MinimumLength = 1)]
            [Display(Name = "First Name")]
            public string FirstName { get; set; }


            [Required]
            [StringLength(100, ErrorMessage = "The  Last Name Field Must be at least One character.", MinimumLength = 1)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        //admin user has logged in and tried to create a new user
                        await _userManager.AddToRoleAsync(user, WebConstants.AdminRole);
                    ...
                    else
                    {
                        ...
                        // not an admin, assigned to customer. 
                    }
